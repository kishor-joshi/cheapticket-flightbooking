...
public class OneWayFlightBooking extends BaseClass{
	...
	public void bookTicket(String[] arr) throws InterruptedException
	{
		...
		WebElement from = waitAndGetElement(30, driver,prop.getProperty("from"));
		from.sendKeys(arr[0]);
		Thread.sleep(1000);
		WebElement to = waitAndGetElement(30, driver,prop.getProperty("to"));
		to.sendKeys(arr[1]);
		Thread.sleep(1000);
		...
		Thread.sleep(3000);
		WebElement book=waitAndGetElement(30,driver,prop.getProperty("book"));
        book.click();
        Thread.sleep(1000);
